...
export default function ProfilePage() {
  ...
  return (
    <div className="min-h-screen relative bg-gray-100">
      ...
      {!isLoggedIn && (
        <div className="absolute left-1/2 bottom-60 -translate-x-1/2 w-11/12 max-w-sm bg-white/90 backdrop-blur-sm flex flex-col items-center justify-center z-50 rounded-lg p-6 shadow-lg">
