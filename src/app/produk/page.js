              ...
              <div className="relative w-full overflow-hidden rounded-t-2xl">
                ...
                <div className="absolute bottom-0 left-0 right-0 flex">
                  ...
                  <div className="flex flex-col bg-teal-500 text-white px-1 py-[1px] leading-tight">
                    ...
                    <span className="text-[8px] font-semibold items-center">XTRA</span>
                  </div>

                  {/* Hemat Pakai Bonus */}
                  <div className="flex flex-col bg-yellow-400 text-black px-1 py-[1px] leading-tight">
                    <span className="text-[8px] opacity-90">Hemat Pakai</span>
                    <span className="text-[8px] font-semibold items-center">Bonus</span>
                  </div>

                  {/* COD */}
                  <div className="flex flex-col bg-orange-500 text-white px-1 py-[1px] leading-tight">
                    <span className="text-[8px] opacity-90 items-center">Bisa</span>
                    <span className="text-[8px] font-semibold items-center">COD</span>
                  </div>
                </div>
              </div>
